...
func RunKubeletBootstrap(templateDir string, kubeletConfigs []*mcfgv1.KubeletConfig, controllerConfig *mcfgv1.ControllerConfig, features *configv1.FeatureGate, mcpPools []*mcfgv1.MachineConfigPool, node *configv1.Node) ([]*mcfgv1.MachineConfig, error) {
	...
	for _, kubeletConfig := range kubeletConfigs {
		...
		for _, pool := range mcpPools {
			...
			// updating the original kubelet configuration with the Node specific configuration.
			if node == nil {
